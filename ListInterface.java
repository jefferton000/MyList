...
public interface ListInterface<T>
{
  ...
  /** Task: Removes an entry at a given position from the list.
   ...
   *  @return true if the list is empty, or false is not. */
  public boolean isEmpty();
  
  /** Task: Sees whether the list is full.
   *  @return true if the list is full, or false is not. */
